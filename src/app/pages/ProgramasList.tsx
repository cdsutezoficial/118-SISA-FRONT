...
const rows = [
  { id: 1, nombre: 'Ingeniería en Desarrollo y Gestión de Software', clave: 'IDGS', division: 'DTI', claveDGP: '220740067' },
  { id: 2, nombre: 'Técnico Superior Universitario en TI', clave: 'TSU-TI', division: 'DTI', claveDGP: '220740001' },
  { id: 3, nombre: 'Licenciatura en Administración de Empresas', clave: 'LAE', division: 'DCEA', claveDGP: '230120015' },
    ...
    <div className="max-w-[1100px] mx-auto px-8 py-8">
      ...
      <div className="bg-white border border-[#E5E7EB] rounded-lg overflow-hidden">
        <div className="px-4 py-3 border-b border-[#E5E7EB] flex items-center gap-3">
          <div className="w-48">
            <SearchSelect options={divisiones} value={division} onChange={setDivision} placeholder="División…" />
          </div>
          ...
          <tbody>
            {filtered.map(row => (
              <tr key={row.id} className="border-b border-[#E5E7EB] last:border-0 hover:bg-[#F8F9FA] transition-colors">
                ...
                <td className="px-4 py-3 text-[#6B7280]">{row.division}</td>
