...
- [x] 2.5 Screen 4 Registro Wizard (dual-mount) — `pages/admision/CandidatoRegistro.tsx` w/ `origin` prop; routes `/admision/candidatos/registrar` (staff) + `/portal/registro` (public); LlaveMX gate, isFirstChoice, payment-method gate (uses Wizard, 1.5)
...
- [ ] 2.7 Screen 6 Confirmar Pago Ficha — `pages/admision/ConfirmarPagoFicha.tsx`, route `/admision/candidatos/pago-ficha`; FileUpload, sets PAID
- [ ] 2.8 Screen 10 Confirmar Pago Inducción — `pages/admision/ConfirmarPagoInduccion.tsx`, route `/admision/candidatos/pago-induccion`; FileUpload, unlocks Screen 8
- [ ] 2.9 Screen 8 Registro Inducción — `pages/admision/RegistroInduccion.tsx`, route `/admision/candidatos/induccion`; locked until induction paid, banner links to 2.8 (depends on 2.8)
- [ ] 2.10 Screen 7 Registro Examen — `pages/admision/RegistroExamen.tsx`, route `/admision/candidatos/examen`; live Aprobado/Reprobado vs 60
